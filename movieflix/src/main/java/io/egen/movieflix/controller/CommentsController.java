...
public class CommentsController {
	...
	@RequestMapping(method = RequestMethod.POST,path="/add/{movieId}/{userId}",produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public Comments add(@PathVariable("movieId") String movieId,@PathVariable("userId") String userId, @RequestBody Comments comment) {
		return service.add(movieId,userId, comment);		 
	}
